                            ...
                            <Formik
                                ...
                                onSubmit={async (values, {resetForm}) => {
                                    try {
                                        ...
                                        authId = parseInt(authId);
                                        console.log(authId);
                                        return fetch('http://172.17.0.1:3001/users/updateUserPassword', {
                                            method: 'PUT',
                                            headers: {
                                                Accept: 'application/json',
                                                'Authorization': `Bearer ${token}`,
                                            ...
                                            body: JSON.stringify({authId: authId, password: values.password}),
                                        })
                                            .then((response) => response.json())
                                            .then((responseJson) => {
                                    ...
                                    <View>
                                        ...
                                        <View>
                                            ...
                                            <HelperText type="error"
                                                        ...
                                                        values.confirmPassword !== values.password ? true : false}>
                                                {values.confirmPassword !== values.password ? 'Password not matched' : errors.confirmPassword}
                                            </HelperText>
                                        </View>
